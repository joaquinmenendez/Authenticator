...
def video2frame(s3_client, video_path , bucket_name, person_name, mod_num, rotate ):
	...
	for n,frame in enumerate(frames):
		p_name =  f"{person_name}/Frames/{person_name}_{n}.pickle" #it's saving as an object every frame
		...
		print(f'{p_name} has been succesfully uploaded. {n+1} of {total_files} remaining')
